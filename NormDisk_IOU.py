...
path2 = r"/home/nem2/Documents/HAM/NormDiskID-pc/"
...
for j in range(len(humanmaskfiles)): 
    ...
    for i in range(len(Mymaskfiles)):
        ...
        #shutil.copy(path2+Mymaskfiles[i]+"/newmask0.png", path4 + "MASK0/"+Mymaskfiles[i][0:12]+".png")
        #shutil.copy(path2+Mymaskfiles[i]+"/newmask1.png", path4 + "MASK1/"+Mymaskfiles[i][0:12]+".png")
        ...
        if Mymaskfiles[i][0:12] == humanmaskfiles[j][0:12]: #Retrieves ID string
           ...
           # MM = MyMask.f.arr_0  #turns dictionary to readable array
            ...
            Mask0 = np.load(path2 + Mymaskfiles[i] + "/diskArr0.npz")
            Mask0 = Mask0.f.arr_0
            
            Mask1 = np.load(path2 + Mymaskfiles[i] + "/diskArr1.npz")
            Mask1 = Mask1.f.arr_0
            ...
            Inter_valueM2 = Mask2[(Mask2 == 255) & (HM == 255)]
            ...
            union_valueM2 = Mask2[(Mask2 == 255) | (HM == 255)]
